...
<body>
    <header class="head">
        <a href="#" class="logo"><i class="fas fa-heart"></i>&nbsp;Viv<span>AH</span>a&nbsp;<i class="fas fa-heart"></i></a>
        <nav class="navbar ">
    ...
    <section class="service" id="service">
        ...
        <div class="services-row">
            <div class="services-col">
                ...
                <h2>invitation</h2>
                <p>We provide best invitaion card desig with your requirement.</p>
            </div>
            <div class="services-col">
                <i class="fas fa-camera"></i>
                <h2>Photography & Video</h2>
                <p>Finding the "best" photographer for your wedding depends on your personal preferences, budget, and the style of photography.</p>
            </div>
            <div class="services-col">
                <i class="fas fa-brush"></i>
                <h2>Beauty & Makeup</h2>
                <p> aim for a makeup look that enhances your natural beauty and makes you feel confident. Consider factors like your dress, venue, and lighting.</p>
            </div>
            <div class="services-col">
    ...
    <footer id="contact">
        <div class="container">
            ...
            <div class="f-container">
                <h2>Our Location</h2>
                <a href="#"><i class="fas fa-angle-right"></i>Bhoapl</a>
                <a href="#"><i class="fas fa-angle-right"></i>Indore</a>
                <a href="#"><i class="fas fa-angle-right"></i>Sagar</a>
                <a href="#" "><i class=" fas fa-angle-right "></i>chhtarpur</a>
                    <a href="# "><i class="fas fa-angle-right "></i>Panna</a>
                </div>
